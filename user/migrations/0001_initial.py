    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patronymic', models.CharField(blank=True, help_text='Отчество', max_length=77, null=True, verbose_name='Отчество')),
                ('avatar', models.ImageField(blank=True, help_text='Аватар', null=True, upload_to='struct/employee/avatars/', verbose_name='Аватар')),
                ('is_director', models.BooleanField(default=False, help_text='Руководитель', verbose_name='Руководитель')),
                ('date_birth', models.DateTimeField(blank=True, help_text='Дата рождения', null=True, verbose_name='Дата рождения')),
                ...
                ('company', models.ForeignKey(help_text='Компания', on_delete=django.db.models.deletion.CASCADE, related_name='related_employee_company', to='structure.company', verbose_name='Компания')),
                ('division', models.ForeignKey(blank=True, help_text='Подразделение', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='related_employee_division', to='structure.division', verbose_name='Подразделение')),
